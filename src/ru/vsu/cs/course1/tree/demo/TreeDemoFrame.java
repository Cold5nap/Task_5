...
public class TreeDemoFrame extends JFrame {
    ...
    SimpleBSTree<Integer> bsTree = new SimpleBSTree<>(s -> Integer.parseInt(s));
...
*/
    public TreeDemoFrame() {
        ...
        greaterButton.addActionListener(actionEvent -> {
            try {
                String text = inputTextField.getText();
                if (!text.matches("[-+]?\\d+")) throw new Exception("Введите целое число");

                Integer value = Integer.valueOf(text);
                Integer great = bsTree.getGreaterOrEqual(value);
                if (great == null)
                    outputTextField.setText("Больше, чем указанное число, в дереве не содержится.");
                else
                    outputTextField.setText(String.valueOf(great));
            } catch (Exception ex) {
                SwingUtils.showErrorMessageBox(ex);
            }
        });
        lessButton.addActionListener(actionEvent -> {
            try {
                String text = inputTextField.getText();
                if (!text.matches("[-+]?\\d+")) throw new Exception("Введите целое число");
                Integer value = Integer.valueOf(inputTextField.getText());
                Integer less = bsTree.getLessOrEqual(value);
                if (less == null)
                    outputTextField.setText("Меньше, чем указанное число, в дереве не содержится.");
                else
                    outputTextField.setText(String.valueOf(less));
            } catch (Exception ex) {
                SwingUtils.showErrorMessageBox(ex);
            }
        });
        minButton.addActionListener(actionEvent -> {
            try {
                Integer value = bsTree.getMin();
                outputTextField.setText(String.valueOf(value));
            } catch (Exception ex) {
                SwingUtils.showErrorMessageBox(ex);
            }
        });
        maxButton.addActionListener(actionEvent -> {
            try {
                Integer value = bsTree.getMax();
                outputTextField.setText(String.valueOf(value));
            } catch (Exception ex) {
                SwingUtils.showErrorMessageBox(ex);
            }
        ...
        buttonMakeBSTree.addActionListener(actionEvent -> {
            try {
                bsTree.fromBracketNotation(textFieldBracketNotationTree.getText());
                this.tree = bsTree;
                repaintTree();
            } catch (Exception ex) {
                SwingUtils.showErrorMessageBox(ex);
        ...
        /*buttonPreOrderTraverse.addActionListener(actionEvent -> {
            showSystemOut(() -> {
                ...
                for (Integer maxValue : tree.preOrderValues()) {
        ...
        /*buttonInOrderTraverse.addActionListener(actionEvent -> {
            showSystemOut(() -> {
                ...
                System.out.println();
                System.out.println("Итератор:");
                for (Integer maxValue : tree.inOrderValues()) {
                    System.out.println(maxValue);
                }
            });
        });
        buttonPostOrderTraverse.addActionListener(actionEvent -> {
            showSystemOut(() -> {
                ...
                System.out.println();
                System.out.println("Итератор:");
                for (Integer maxValue : tree.postOrderValues()) {
                    System.out.println(maxValue);
                }
            });
        });
        buttonByLevelTraverse.addActionListener(actionEvent -> {
            showSystemOut(() -> {
                ...
                System.out.println();
                System.out.println("Итератор:");
                for (Integer maxValue : tree.byLevelValues()) {
                    System.out.println(maxValue);
                }
            });
        });
